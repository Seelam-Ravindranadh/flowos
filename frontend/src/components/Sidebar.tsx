...
export function Sidebar({
  ...
  const handleNavigate = (key: NavKey) => {
    ...
    switch (key) {
      ...
      default:
        console.warn("Unknown navigation:", key);
    }
  };
    ...
    <>
      ...
      >
        ...
        <div className="flex h-16 items-center justify-between px-5">
          ...
          >
            ...
            <div className="text-left">
              <div className="font-display text-[15px] font-bold leading-none text-slate-900 dark:text-white">
                FlowOS
              </div>
        ...
        <div className="hidden border-t border-slate-200/70 px-5 py-3 text-[11px] text-slate-400 dark:border-white/5 lg:flex lg:items-center lg:gap-2">
          ...
          Press{" "}
          <kbd className="rounded bg-slate-100 px-1 py-0.5 font-mono text-[10px] dark:bg-white/10">
            ⌘K
          </kbd>{" "}
          to search
        </div>
  ...
  return (
    ...
    >
      ...
      <rect
        ...
        height="32"
        rx="8"
        fill="url(#flowos-logo)"
      />

      <path
        d="M9 21c3.5 0 4.5-10 8-10s4.5 6 6 6"
        stroke="white"
        strokeWidth="2.4"
        strokeLinecap="round"
        fill="none"
